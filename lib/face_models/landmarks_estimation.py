...
# from face_models.sfd.sfd_detector import SFDDetector as FaceDetector
# from face_models.fan_model.models import FAN, ResNetDepth
# from face_models.fan_model.utils import *
...
class LandmarksEstimation():
	def __init__(self, type='3D', path_to_detector='models/pretrained/sfd/s3fd-619a316812.pth'):
